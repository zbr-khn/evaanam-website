        ...
        <div className="max-w-7xl mx-auto">
          <div className="max-w-3xl space-y-6">
            ...
            <h1 className="editorial-heading text-5xl sm:text-6xl md:text-7xl text-chocolate-950 dark:text-cream-50">
              People who know <br />
              <span className="italic text-bronze-600 dark:text-bronze-400">how the floor moves.</span>
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
            ...
            <div className="lg:col-span-4 space-y-6">
              <div className="sticky top-32 space-y-4">
                <span className="micro-label text-bronze-600 dark:text-bronze-400">CHAPTER 01</span>
                <h2 className="editorial-heading text-3xl sm:text-4xl text-chocolate-950 dark:text-cream-50">
                  Wedding Hospitality
                </h2>
                <p className="text-base text-chocolate-600 dark:text-bronze-300 font-serif italic">
                  Five-star floors, multi-day functions, VIP coverage.
                </p>
                <p className="text-xs text-chocolate-500 dark:text-night-muted font-light leading-relaxed">
            ...
            <div className="lg:col-span-8 space-y-3">
              <div className="flex items-center justify-between pb-3 border-b border-chocolate-700/15 dark:border-night-700 text-xs uppercase tracking-wider font-semibold text-chocolate-600 dark:text-night-muted">
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="w-8 h-8 rounded-full flex items-center justify-center bg-cream-100 dark:bg-night-750 border border-chocolate-700/15 dark:border-bronze-500/20 text-chocolate-700 dark:text-cream-200">
                        {isOpen ? <Minus className="w-4 h-4 text-bronze-600 dark:text-bronze-400" /> : <Plus className="w-4 h-4" />}
                      </div>
                    </button>

                    {isOpen && (
                      <div className="px-6 pb-6 pt-1 text-xs sm:text-sm text-chocolate-600 dark:text-night-muted font-light leading-relaxed border-t border-chocolate-700/10 dark:border-night-700 animate-fade-in">
                        <p>{role.desc}</p>
                        <div className="mt-4 pt-3 flex flex-wrap items-center gap-4 text-[11px] font-mono text-chocolate-500 dark:text-night-dim">
                          <span className="flex items-center space-x-1 text-bronze-600 dark:text-bronze-400">
      ...
      <section className="py-24 px-6 sm:px-8 lg:px-12 bg-cream-200 dark:bg-night-900 border-b border-chocolate-700/10 dark:border-bronze-500/15">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
            ...
            <div className="lg:col-span-4 space-y-6">
              <div className="sticky top-32 space-y-4">
                <span className="micro-label text-bronze-600 dark:text-bronze-400">CHAPTER 02</span>
                <h2 className="editorial-heading text-3xl sm:text-4xl text-chocolate-950 dark:text-cream-50">
                  Corporate &amp; Expos
                </h2>
                <p className="text-base text-chocolate-600 dark:text-bronze-300 font-serif italic">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                return (
                  <div
                    ...
                    className={`p-6 border-b transition-all duration-300 cursor-pointer ${
                      isHovered
                        ? "border-bronze-500 bg-cream-50 dark:bg-night-800 pl-8"
                        : "border-chocolate-700/10 dark:border-night-700 hover:border-chocolate-700/30 dark:hover:border-bronze-500/40"
                    }`}
                  >
                    <div className="flex items-center justify-between">
                      <h3
                        className={`font-serif text-2xl sm:text-3xl transition-colors ${
                          isHovered ? "text-chocolate-950 dark:text-cream-50 font-medium" : "text-chocolate-600 dark:text-night-muted"
                        }`}
                      >
                        {type.title}
                      </h3>
                      <span className="font-mono text-xs text-bronze-600 dark:text-bronze-400">
                        0{idx + 1}
                      </span>
                    </div>

                    <p className="text-xs font-serif italic text-bronze-600 dark:text-bronze-400 mt-1">
                      {type.subtitle}
                    </p>
                      ...
                      <div className="mt-3 animate-fade-in space-y-2">
                        ...
                        <div className="flex flex-wrap gap-1.5 pt-1">
                          {type.tags.map((tag) => (
                            <span
                              key={tag}
                              className="text-[10px] uppercase font-sans tracking-wider px-2 py-0.5 bg-cream-200 dark:bg-night-900 text-chocolate-700 dark:text-cream-200 border border-chocolate-700/10 dark:border-bronze-500/20"
                            >
                              {tag}
                            </span>
                          ))}
            ...
            <div className="lg:col-span-5 hidden lg:block">
              <div className="relative overflow-hidden border border-chocolate-700/15 dark:border-bronze-500/20 aspect-[4/5] shadow-lg bg-night-950">
                <img
