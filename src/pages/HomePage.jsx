...
export default function HomePage() {
  ...
  return (
    <div className="animate-fade-in">
      {/* 1. HERO SECTION */}
      <section className="relative min-h-[92vh] sm:min-h-screen flex items-center justify-center pt-28 pb-16 px-6 sm:px-8 lg:px-12 overflow-hidden bg-chocolate-950 text-cream-100">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          <img
            ...
            className="w-full h-full object-cover object-center ken-burns opacity-35"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-chocolate-950 via-chocolate-950/70 to-chocolate-950/80" />
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-end">
            <div className="lg:col-span-8 space-y-6">
              {/* Micro Eyebrow */}
              <div className="inline-flex items-center space-x-2.5 px-3 py-1.5 bg-chocolate-900/90 border border-bronze-500/30 rounded-sm">
              ...
              <div className="pt-4 flex flex-col sm:flex-row items-stretch sm:items-center space-y-3.5 sm:space-y-0 sm:space-x-4">
                ...
                >
                  ...
                  <ArrowUpRight className="w-4 h-4 ml-2 text-chocolate-950 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
                </Link>

                <Link
                  to="/services"
                  className="inline-flex items-center justify-center px-7 py-3.5 border border-cream-200/30 text-cream-100 font-sans text-xs font-semibold uppercase tracking-[0.18em] transition-all hover:bg-cream-200 hover:text-chocolate-950"
                >
            ...
            <div className="lg:col-span-4 hidden lg:flex flex-col justify-end">
              <div className="p-6 bg-chocolate-900/80 border border-bronze-500/20 backdrop-blur-sm space-y-3">
                ...
                <div className="pt-2 border-t border-chocolate-800 flex items-center justify-between text-[11px] text-cream-300/70 font-sans">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-6 space-y-4">
              ...
              <h2 className="editorial-heading text-4xl sm:text-5xl lg:text-6xl text-chocolate-950">
                ...
                <span className="text-bronze-600 italic">Operations underneath.</span>
              </h2>
            </div>

            {/* Right: Detailed Context & Navigation Gateway */}
            <div className="lg:col-span-6 space-y-6">
              <p className="text-base sm:text-lg text-chocolate-700 font-light leading-relaxed">
              ...
              <div className="pt-2">
                <Link
                  to="/why-us"
                  className="inline-flex items-center space-x-2 text-xs uppercase tracking-[0.2em] font-semibold text-chocolate-900 hover:text-bronze-600 transition-colors border-b border-bronze-500/50 pb-1"
                >
      ...
      <section className="py-24 px-6 sm:px-8 lg:px-12 bg-cream-200">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            <div>
              ...
              <h2 className="editorial-heading text-4xl sm:text-5xl text-chocolate-950 mt-2">
                ...
                <span className="italic text-bronze-600">Held to one standard.</span>
              </h2>
            </div>
            <Link
              to="/services"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="card-luxury p-8 sm:p-10 flex flex-col justify-between group hover:border-bronze-500/50 transition-all">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="font-mono text-xs font-semibold text-bronze-600">01 / WEDDING</span>
                  <span className="text-[11px] uppercase tracking-wider text-chocolate-500 font-sans">14 Specialist Roles</span>
                </div>
                <h3 className="font-serif text-3xl text-chocolate-950 font-medium">
                  Wedding Hospitality
                </h3>
                <p className="text-sm text-chocolate-600 font-serif italic">
                  Five-star floors, multi-day functions, VIP coverage.
                </p>
                <p className="text-xs text-chocolate-600/90 font-light leading-relaxed">
                ...
                <div className="flex flex-wrap gap-2 pt-2">
                  {["VIP Shadows", "Welcome Hostesses", "Helpdesk Crew", "Runners", "Stewards"].map((tag) => (
                    <span key={tag} className="text-[11px] px-2.5 py-1 bg-cream-200 text-chocolate-700 border border-chocolate-700/10">
                      {tag}
                    </span>
                  ))}
                </div>
              ...
              <div className="mt-8 pt-6 border-t border-chocolate-700/10">
                <Link
                  to="/services"
            ...
            <div className="card-luxury p-8 sm:p-10 flex flex-col justify-between group hover:border-bronze-500/50 transition-all">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="font-mono text-xs font-semibold text-bronze-600">02 / CORPORATE</span>
                  <span className="text-[11px] uppercase tracking-wider text-chocolate-500 font-sans">13 Specialist Roles</span>
                </div>
                <h3 className="font-serif text-3xl text-chocolate-950 font-medium">
                  Corporate &amp; Expos
                </h3>
      ...
      <section className="relative h-[480px] sm:h-[550px] flex items-center justify-center overflow-hidden bg-chocolate-950 text-cream-100 text-center px-6">
        <div className="absolute inset-0 z-0 overflow-hidden">
          <img
            src="https://images.unsplash.com/photo-1511795409834-ef04bbd61622?auto=format&fit=crop&w=2000&q=85"
            alt="Event Floor in Motion"
            className="w-full h-full object-cover object-center ken-burns opacity-30"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-chocolate-950/90 via-chocolate-950/60 to-chocolate-950/90" />
        </div>
      ...
      <section className="py-16 bg-cream-200">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 mb-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <Link
            to="/venues"
            className="inline-flex items-center space-x-1.5 text-xs uppercase tracking-[0.18em] font-semibold text-chocolate-900 hover:text-bronze-600 transition-colors"
          >
      ...
      {/* 7. GALLERY TEASER */}
      <section className="py-24 px-6 sm:px-8 lg:px-12 bg-cream-100/80 border-t border-chocolate-700/10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {teaserImages.map((img) => (
              <Link
                key={img.id}
                to="/gallery"
                className="group relative overflow-hidden bg-cream-200 border border-chocolate-700/10 aspect-[4/3] block"
              >
                <img
                  src={img.src}
                  alt={img.title}
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-chocolate-950/80 via-transparent to-transparent opacity-80 group-hover:opacity-95 transition-opacity" />
      ...
      <section className="py-24 px-6 sm:px-8 lg:px-12 bg-cream-200 border-t border-chocolate-700/10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-base text-chocolate-600 font-light max-w-xl mx-auto leading-relaxed">
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            ...
            <a
              ...
              className="text-xs uppercase tracking-[0.2em] font-semibold text-chocolate-800 hover:text-bronze-600 transition-colors"
            >
